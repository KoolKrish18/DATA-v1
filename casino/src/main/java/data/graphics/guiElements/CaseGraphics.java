...
public class CaseGraphics extends JButton {
    ...
    public static ImageIcon openIcon = new ImageIcon(Paths.get("").toAbsolutePath().toString() + "\\casino\\src\\main\\resources\\Chest_Opened.png"); 
    ...
    public static void initCaseGraphics() {
        ...
        try {
            glow = ImageIO.read(new File(Paths.get("").toAbsolutePath().toString() + "\\casino\\src\\main\\resources\\Glow.png"));
